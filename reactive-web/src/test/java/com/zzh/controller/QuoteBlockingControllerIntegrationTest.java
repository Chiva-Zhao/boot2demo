...
import com.zzh.web.config.WebDataLoader;
import com.zzh.web.domain.Quote;
import com.zzh.web.repository.QuoteMongoBlockingRepository;
...
public class QuoteBlockingControllerIntegrationTest {
    ...
    // This one is not needed, but we need to override the real one to prevent the delt behavior
    @MockBean
    private WebDataLoader webDataLoader;
